...
export const SpriteAnimationSchema = yup.object({
    angle: yup.number().typeError('Only numbers').positive().min(0, "Must be more than zero").required(),
    angleSpeed: yup.number().typeError('Only numbers').positive().min(0, "Must be more than zero").required(),
    curve: yup.number().typeError('Only numbers').positive().min(0, "Must be more than zero").required(),
}).required();